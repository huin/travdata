...
/// ([relm4_components::open_button::OpenButtonSettings::recently_opened_files]) requires a
/// `&'static str`, but the value must be dynamically generated based on the XDG configuration
/// path.
